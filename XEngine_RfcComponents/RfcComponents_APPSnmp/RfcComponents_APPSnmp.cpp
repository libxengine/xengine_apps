...
int main()
{
	...
	LPCTSTR lpszSnmpAddr = "192.168.1.9";
	...
	st_SNMPProtocol.byOPCode = XENGINE_SNMP_PROTOCOL_BER_TYPE_GET;
	...
	if (!XClient_UDPSelect_Create(&hSocket, lpszSnmpAddr, nPort))
	{
