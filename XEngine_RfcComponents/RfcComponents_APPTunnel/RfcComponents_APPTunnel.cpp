...
//g++ -std=c++17 -Wall -g RfcComponents_APPTunnel.cpp -o RfcComponents_APPTunnel.exe -L ../../../XEngine/XEngine_Release/XEngine_Linux/Ubuntu/XEngine_BaseLib -L ../../../XEngine/XEngine_Release/XEngine_Linux/Ubuntu/XEngine_RfcComponents -lXEngine_BaseLib -lRfcComponents_ProxyServer -Wl,-rpath=../../../XEngine/XEngine_Release/XEngine_Linux/Ubuntu/XEngine_BaseLib:../../../XEngine/XEngine_Release/XEngine_Linux/Ubuntu/XEngine_Core:../../../XEngine/XEngine_Release/XEngine_Linux/Ubuntu/XEngine_Client:../../../XEngine/XEngine_Release/XEngine_Linux/Ubuntu/XEngine_RfcComponents,--disable-new-dtags

void CALLBACK RfcComponents_Callback_Tunnel(LPCSTR lpszClientAddr, LPCSTR lpszMsgBuffer, int nMsgLen, ENUM_RFCCOMPONENTS_PROXYSOCKS_CBUSERTYPE enEvents, LPVOID lParam)
{
...
int main()
{
	...
	int nListCount = 1;
	TCHAR** pptszListUser;
	BaseLib_OperatorMemory_Malloc((XPPPMEM)&pptszListUser, nListCount, 128);
